...
!function ($) {
	...
	* ============== */
	...
	$.ajaxModal = function(customOptions){
		...
		if($modal.length == 0){
			var str = '<div aria-hidden="false" aria-labelledby="myModalLabel" data-backdrop="static" role="dialog" tabindex="-1" data-focus-on="input:first" class="modal fade" id="'+options.id+'"></div>';
