	...
	ModalManager.prototype = {
		...
		loading: function (callback) {
			...
			if (!this.isLoading) {
				...
				$.support.transition ?
					this.$backdropHandle.one($.support.transition.end, callback).emulateTransitionEnd(150) :
					callback();
				...
				var that = this;
				$.support.transition ?
					this.$backdropHandle.one($.support.transition.end, function () { that.removeLoading() }).emulateTransitionEnd(150) :
					that.removeLoading();
